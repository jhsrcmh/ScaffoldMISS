...
class WorklogsControllerTest < ActionController::TestCase
  ...
  test "should create worklog" do
    assert_difference('Worklog.count') do
      post :create, worklog: { logdoc: @worklog.logdoc, place: @worklog.place, project_id: @worklog.project_id, remarkinf: @worklog.remarkinf, time: @worklog.time, user_id: @worklog.user_id }
    end
  ...
  test "should update worklog" do
    put :update, id: @worklog, worklog: { logdoc: @worklog.logdoc, place: @worklog.place, project_id: @worklog.project_id, remarkinf: @worklog.remarkinf, time: @worklog.time, user_id: @worklog.user_id }
    assert_redirected_to worklog_path(assigns(:worklog))
  end
